...
|                           |                            |
|---------------------------|----------------------------|
| **Instructor**            | Craig Clawson              |
| **Optional Co-Working Time**       | Fridays, 9:00–11:50 AM     |
...
AIM lists the course as Fridays 9:00–11:50 AM in TNRB 1216. You're welcome to use this entire block for co-working and peer support, especially if you're working remotely and would benefit from working along side others, even on different projects. Office hours with Professor Clawson are by appointment.

**Required Sessions (9:00–10:30 AM):**

There are only three required sessions throughout the semester:

- **September 18** – Kick-off and expectations
- **October 30** – Midpoint check-in
- **December 4** – End-of-semester wrap-up
...
12 emails × 11.67 points each

| Status | Points |
|--------|--------|
| On time (Saturday by 11:59 PM) | 11.67 pts |
| Late (by Monday 12:00 PM noon) | 5.83 pts |
...
At the end of the internship, your mentor will evaluate you on 5 dimensions using a 1-7 scale. Each score is multiplied by 4. See the [Mentor Evaluation Survey](../partners/03-evaluation.qmd) to understand exactly what your mentor will be asked.
...
**Due Date:** December 11, 2026 (same as internship end date)
...
**Survey Link:** [Complete the Company Feedback Survey](https://docs.google.com/forms/d/e/1FAIpQLSeU57PSA9sjt_iXu7AFtPXMG9OrdV_uhzerJS1xOq9q3JVZPw/viewform?usp=header)
...
Craig Clawson is director of NVIDIA's Deep Learning Institute, which offers certified instruction to help individuals and organizations learn AI and accelerated computing. Craig has focused his career on developing learning solutions for professionals.

Prior to NVIDIA, he served as Dean of the Jack Welch Management Institute, where he led program design and curriculum. Before that he served as Managing Director of Duke Corporate Education, delivering custom learning experiences for clients worldwide.

Craig holds a PhD and MBA from the University of Chicago Booth School of Business. He is a true believer in the power of education to change individuals, organizations and improve society. Outside of work Craig enjoys spending time with his family, hiking and skiing.

## Getting Help

The following resources are available to get help:

-   Use email or Teams to contact the TAs and Professor Clawson
-   Attend office hours
